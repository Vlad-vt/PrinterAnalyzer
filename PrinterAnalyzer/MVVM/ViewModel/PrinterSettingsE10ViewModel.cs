...
namespace PrinterAnalyzer.MVVM.ViewModel
{
    internal class PrinterSettingsE10ViewModel : ObservableObject
    {
        ...
        {
            PrintersViewModel.m_DLLFuncE10.ChangeParameter(_printer.properties, _printer.Name, Enums.PrinterType.SII_RP_F10, Model.PrinterProperties.PropertyType.Margin, 0);
            ChangeMarginButtonColor(0);
        }
        private void MarginToTopMin()
        {
            PrintersViewModel.m_DLLFuncE10.ChangeParameter(_printer.properties, _printer.Name, Enums.PrinterType.SII_RP_F10, Model.PrinterProperties.PropertyType.Margin, 1);
            ChangeMarginButtonColor(1);
        }
        private void MarginBottomMin()
        {
            PrintersViewModel.m_DLLFuncE10.ChangeParameter(_printer.properties, _printer.Name, Enums.PrinterType.SII_RP_F10, Model.PrinterProperties.PropertyType.Margin, 2);
            ChangeMarginButtonColor(2);
        }
        private void MarginToMax()
        {
            PrintersViewModel.m_DLLFuncE10.ChangeParameter(_printer.properties, _printer.Name, Enums.PrinterType.SII_RP_F10, Model.PrinterProperties.PropertyType.Margin, 3);
        ...
        {
            PrintersViewModel.m_DLLFuncE10.ChangeParameter(_printer.properties, _printer.Name, Enums.PrinterType.SII_RP_F10, Model.PrinterProperties.PropertyType.Direction, 0);
            ChangeDirectionButtonColor(0);
        }
        private void DirectionBackward()
        {
            PrintersViewModel.m_DLLFuncE10.ChangeParameter(_printer.properties, _printer.Name, Enums.PrinterType.SII_RP_F10, Model.PrinterProperties.PropertyType.Direction, 1);
        ...
        {
            PrintersViewModel.m_DLLFuncE10.ChangeParameter(_printer.properties, _printer.Name, Enums.PrinterType.SII_RP_F10, Model.PrinterProperties.PropertyType.Orientation, 0);
            ChangeOrientationButtonColor(0);
        }

        private void SetOrientationLandscape()
        {
            PrintersViewModel.m_DLLFuncE10.ChangeParameter(_printer.properties, _printer.Name, Enums.PrinterType.SII_RP_F10, Model.PrinterProperties.PropertyType.Orientation, 1);
        ...
        {
            PrintersViewModel.m_DLLFuncE10.ChangeParameter(_printer.properties, _printer.Name, Enums.PrinterType.SII_RP_F10, Model.PrinterProperties.PropertyType.FeedToCutPosition, 0);
            ChangeFeedButtonColor(0);
        }
        private void DisableFeed()
        {
            PrintersViewModel.m_DLLFuncE10.ChangeParameter(_printer.properties, _printer.Name, Enums.PrinterType.SII_RP_F10, Model.PrinterProperties.PropertyType.FeedToCutPosition, 1);
        ...
        {
            PrintersViewModel.m_DLLFuncE10.ChangeParameter(_printer.properties, _printer.Name, Enums.PrinterType.SII_RP_F10, Model.PrinterProperties.PropertyType.PaperCut, 0);
            ChangeCutButtonColor(0);
        }

        private void SetFullCutByJob()
        {
            PrintersViewModel.m_DLLFuncE10.ChangeParameter(_printer.properties, _printer.Name, Enums.PrinterType.SII_RP_F10, Model.PrinterProperties.PropertyType.PaperCut, 1);
            ChangeCutButtonColor(1);
        }

        private void SetPartialCutByJobs()
        {
            PrintersViewModel.m_DLLFuncE10.ChangeParameter(_printer.properties, _printer.Name, Enums.PrinterType.SII_RP_F10, Model.PrinterProperties.PropertyType.PaperCut, 2);
            ChangeCutButtonColor(2);
        }

        private void SetFullCutByPage()
        {
            PrintersViewModel.m_DLLFuncE10.ChangeParameter(_printer.properties, _printer.Name, Enums.PrinterType.SII_RP_F10, Model.PrinterProperties.PropertyType.PaperCut, 3);
            ChangeCutButtonColor(3);
        }

        private void SetPartialCutByPage()
        {
            PrintersViewModel.m_DLLFuncE10.ChangeParameter(_printer.properties, _printer.Name, Enums.PrinterType.SII_RP_F10, Model.PrinterProperties.PropertyType.PaperCut, 4);
            ChangeCutButtonColor(4);
        }

        private void SetPartialCutBetweenPages()
        {
            PrintersViewModel.m_DLLFuncE10.ChangeParameter(_printer.properties, _printer.Name, Enums.PrinterType.SII_RP_F10, Model.PrinterProperties.PropertyType.PaperCut, 5);
